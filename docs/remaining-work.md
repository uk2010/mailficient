...
12. Compose safety regressions cover local Enchant/Aspell spell checking with an offline fallback, forgotten-attachment detection, configurable 5–30 second Undo Send, crash-safe delayed delivery, and reopening an undone message as an editable draft.
