...
public class ShortcutsDialog : Adw.PreferencesDialog {
    public ShortcutsDialog () {
        ...
        add_shortcut_row (mail, "Archive", "Ctrl+Shift+A"); add_shortcut_row (mail, "Move to Trash", "Delete");
        add_shortcut_row (mail, "Flag or Unflag", "Ctrl+Shift+L"); add_shortcut_row (mail, "Mark Read or Unread", "Ctrl+Shift+U");
        ...
        add_shortcut_row (navigation, "Next Message", "Alt+Down"); add_shortcut_row (navigation, "Previous Message", "Alt+Up");
