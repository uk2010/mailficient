...
[v0.1.10 GitHub release](https://github.com/uk2010/mailficient/releases/tag/v0.1.10),
...
sudo snap install --dangerous ./mailficient_0.1.10_arm64.snap
...
```sh
tools/build-deb.sh
sudo apt install ./dist/mailficient_0.1.10-1_$(dpkg --print-architecture).deb
mailficient
```
