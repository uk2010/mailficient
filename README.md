...
[v0.2.7 GitHub release](https://github.com/uk2010/mailficient/releases/tag/v0.2.7),
...
sudo snap install --dangerous ./mailficient_0.2.7_arm64.snap
...
```sh
tools/build-deb.sh
sudo apt install ./dist/mailficient_0.2.7-1_$(dpkg --print-architecture).deb
mailficient
```
