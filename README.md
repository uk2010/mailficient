...
[v0.1.17 GitHub release](https://github.com/uk2010/mailficient/releases/tag/v0.1.17),
...
sudo snap install --dangerous ./mailficient_0.1.17_arm64.snap
...
```sh
tools/build-deb.sh
sudo apt install ./dist/mailficient_0.1.17-1_$(dpkg --print-architecture).deb
mailficient
```
