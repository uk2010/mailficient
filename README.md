...
Download `Mailficient-0.1.5-x86_64.flatpak` from the
[v0.1.5 GitHub release](https://github.com/uk2010/mailficient/releases/tag/v0.1.5),
...
sudo snap install --dangerous ./mailficient_0.1.5_arm64.snap
...
```sh
tools/build-deb.sh
sudo apt install ./dist/mailficient_0.1.5-1_$(dpkg --print-architecture).deb
mailficient
```
